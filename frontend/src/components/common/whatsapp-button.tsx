  ...
  return (
    ...
    >
      <button
        ...
        className="flex items-center gap-3 bg-luxury-gold text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:bg-luxury-charcoal transition-all duration-300 group"
